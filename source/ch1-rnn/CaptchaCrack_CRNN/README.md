...
```angular2html
🌳 CRNN<all params:8186123>
├── Sequential(feature_extractor)
│   ├── Conv2d(0)|weight[64,1,3,3]|bias[64]
│   ├── Conv2d(2)|weight[128,64,3,3]|bias[128]
│   ├── Conv2d(4)|weight[256,128,3,3]|bias[256]
│   ├── Conv2d(5)|weight[256,256,3,3]|bias[256]
│   ├── Conv2d(7)|weight[512,256,3,3]|bias[512]
│   ├── 💠 BatchNorm2d(8-8,10-10)<🦜:1024x2>|weight[512]|bias[512]
│   ├── Conv2d(9)|weight[512,512,3,3]|bias[512]
│   └── Conv2d(12)|weight[512,512,2,1]|bias[512]
├── LSTM(lstm)|weight_ih_l0[1024,512]|weight_hh_l0[1024,256]|bias_ih_l0[1024]|bi
│   as_hh_l0[1024]|weight_ih_l0_reverse[1024,512]|weight_hh_l0_reverse[1024,256]
│   |bias_ih_l0_reverse[1024]|bias_hh_l0_reverse[1024]|weight_ih_l1[1024,512]|we
│   ight_hh_l1[1024,256]|bias_ih_l1[1024]|bias_hh_l1[1024]|weight_ih_l1_reverse[
│   1024,512]|weight_hh_l1_reverse[1024,256]|bias_ih_l1_reverse[1024]|bias_hh_l1
│   _reverse[1024]
└── Linear(fc_layer)|weight[11,512]|bias[11]
```
