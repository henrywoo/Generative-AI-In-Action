...
```angular2html
🌳 EncodecModel<all params:14851810>
├── EncodecEncoder(encoder)
│   └── ModuleList(layers)
│       ├── EncodecConv1d(0)
│       │   └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,1,7]
│       ├── EncodecResnetBlock(1)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[16]|weight_g[16,1,1]|weight_v[16,32,3]
│       │   │   └── EncodecConv1d(3)
│       │   │       └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,16,1]
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,32,1]
│       ├── EncodecConv1d(3)
│       │   └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,32,4]
│       ├── EncodecResnetBlock(4)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,64,3]
│       │   │   └── EncodecConv1d(3)
│       │   │       └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,32,1]
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,64,1]
│       ├── EncodecConv1d(6)
│       │   └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,64,8]
│       ├── EncodecResnetBlock(7)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,128,3]
│       │   │   └── EncodecConv1d(3)
│       │   │       └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,64,1]
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,128,1]
│       ├── EncodecConv1d(9)
│       │   └── Conv1d(conv)|bias[256]|weight_g[256,1,1]|weight_v[256,128,10]
│       ├── EncodecResnetBlock(10)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,256,3]
│       │   │   └── EncodecConv1d(3)
│       │   │       └── Conv1d(conv)|bias[256]|weight_g[256,1,1]|weight_v[256,128,1]
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[256]|weight_g[256,1,1]|weight_v[256,256,1]
│       ├── EncodecConv1d(12)
│       │   └── Conv1d(conv)|bias[512]|weight_g[512,1,1]|weight_v[512,256,16]
│       ├── EncodecLSTM(13)
│       │   └── LSTM(lstm)|weight_ih_l0[2048,512]|weight_hh_l0[2048,512]|bias_ih_l0[2048]|bias_hh_l0[2048]|weight_ih_l1[2048,512]|weight_hh_l1[2048,512]|bias_ih_l1[2048]|bias_hh_l1[2048]
│       └── EncodecConv1d(15)
│           └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,512,7]
├── EncodecDecoder(decoder)
│   └── ModuleList(layers)
│       ├── EncodecConv1d(0)
│       │   └── Conv1d(conv)|bias[512]|weight_g[512,1,1]|weight_v[512,128,7]
│       ├── EncodecLSTM(1)
│       │   └── LSTM(lstm)|weight_ih_l0[2048,512]|weight_hh_l0[2048,512]|bias_ih_l0[2048]|bias_hh_l0[2048]|weight_ih_l1[2048,512]|weight_hh_l1[2048,512]|bias_ih_l1[2048]|bias_hh_l1[2048]
│       ├── EncodecConvTranspose1d(3)
│       │   └── ConvTranspose1d(conv)|bias[256]|weight_g[512,1,1]|weight_v[512,256,16]
│       ├── EncodecResnetBlock(4)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,256,3]
...
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[256]|weight_g[256,1,1]|weight_v[256,256,1]
│       ├── EncodecConvTranspose1d(6)
│       │   └── ConvTranspose1d(conv)|bias[128]|weight_g[256,1,1]|weight_v[256,128,10]
│       ├── EncodecResnetBlock(7)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,128,3]
...
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[128]|weight_g[128,1,1]|weight_v[128,128,1]
│       ├── EncodecConvTranspose1d(9)
│       │   └── ConvTranspose1d(conv)|bias[64]|weight_g[128,1,1]|weight_v[128,64,8]
│       ├── EncodecResnetBlock(10)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,64,3]
...
│       │   └── EncodecConv1d(shortcut)
│       │       └── Conv1d(conv)|bias[64]|weight_g[64,1,1]|weight_v[64,64,1]
│       ├── EncodecConvTranspose1d(12)
│       │   └── ConvTranspose1d(conv)|bias[32]|weight_g[64,1,1]|weight_v[64,32,4]
│       ├── EncodecResnetBlock(13)
│       │   ├── ModuleList(block)
│       │   │   ├── EncodecConv1d(1)
│       │   │   │   └── Conv1d(conv)|bias[16]|weight_g[16,1,1]|weight_v[16,32,3]
│       │   │   └── EncodecConv1d(3)
...
│       │       └── Conv1d(conv)|bias[32]|weight_g[32,1,1]|weight_v[32,32,1]
│       └── EncodecConv1d(15)
│           └── Conv1d(conv)|bias[1]|weight_g[1,1,1]|weight_v[1,32,7]
└── EncodecResidualVectorQuantizer(quantizer)
    └── ModuleList(layers)
        └── 💠 EncodecVectorQuantization(0-31)<🦜:0x32>
```
