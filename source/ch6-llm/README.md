...
### Why LLM are all based on Transformer, instead of CNN, RNN or MLP?
...
* **log σ (β log ...):**
    ...
    * β is [a parameter controlling the deviation from the base reference policy πref. (Ref: page 4 of DPO paper)](https://arxiv.org/abs/2305.18290) It is originally defined in RL-Finetuning's objective function:
      ![](rl_ft_obj.png)
