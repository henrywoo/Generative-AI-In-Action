...
├── ViTModel(vit)
│   ├── ViTEmbeddings(embeddings)|cls_token[1,1,768]|position_embeddings[1,197,7
│   │   68]
│   │   └── ViTPatchEmbeddings(patch_embeddings)
│   │       └── Conv2d(projection)|weight[768,3,16,16]🇸 -(16, 16)|bias[768]🇸
│   │           -(16, 16)
│   ├── ViTEncoder(encoder)
│   │   └── ModuleList(layer)
...
│   │           ┃   ┃   ┗━━ 💠
│   │           ┃   ┃       Linear(query,key,value)<🦜:590592x3>|weight[768,768]
│   │           ┃   ┃       |bias[768]
...
│   │           ┗━━ 💠
│   │               LayerNorm(layernorm_before,layernorm_after)<🦜:1536x2>|weigh
│   │               t[768]|bias[768]
