...
def train_vqvae(epochs=10, f='model_vqvae.h5'):
    ...
    return vqvae_trainer, quantizer, codebook_indices, pixelcnn_input_shape, num_residual_blocks, num_pixelcnn_layers, encoded_outputs


if __name__ == "__main__":
    vqvae_trainer, quantizer, codebook_indices, pixelcnn_input_shape, num_residual_blocks, num_pixelcnn_layers, encoded_outputs = train_vqvae(epochs=100)
