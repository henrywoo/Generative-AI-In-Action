...
if __name__ == "__main__":
    ...
    parser.add_argument('--vqgan_config', type=str, default='VQGAN/model.yaml', help='Path to VQGAN config file')
    parser.add_argument('--vqgan_checkpoint', type=str, default='VQGAN/last.ckpt', help='Path to VQGAN checkpoint file')
