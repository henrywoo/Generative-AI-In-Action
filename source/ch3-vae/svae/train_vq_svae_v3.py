...
def main(args):
    ...
    model = VQ_SVAE(num_embeddings=BOOK_SIZE//4, embedding_dim=latent_dim, commitment_cost=10,
    ...
    visualize_generated_images(model, num_samples=10, device=device, noise_scale=0.1, version=3)
