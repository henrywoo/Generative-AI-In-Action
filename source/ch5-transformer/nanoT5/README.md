...
```angular2html
🌳 MyT5<all params:247577856>
├── 💠 Embedding(shared),💠 Linear(lm_head)<🦜:24674304x2>|weight[32128,768]
├── T5Stack(encoder)
...
│   │   │       └── T5LayerFF(1)
│   │   │           ├── T5DenseGatedActDense(DenseReluDense)
│   │   │           │   ├── 💠 Linear(wi_0,wi_1)<🦜:1572864x2>|weight[2048,768]
│   │   │           │   └── Linear(wo)|weight[768,2048]
│   │   │           └── T5LayerNorm(layer_norm)|weight[768]
...
```
python -m nanoT5.main optim.name={adafactor,adamwscale} optim.lr_scheduler={legacy,cosine}

python -m nanoT5.main optim.name=adafactor optim.lr_scheduler=legacy
```
